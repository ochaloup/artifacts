These files accompany a https://jbossts.blogspot.com/2021/07/how-to-use-long-running-actions-between-microservices.html[blogpost] that shows Long Running Actions spanning multiple services.
